...
class SnapContainerViewController: UIViewController, UIScrollViewDelegate {
    ...
    var initialStartingPoint: UIViewController!
    ...
    class func containerViewWith(_ leftVC: UIViewController,
                                 ...
                                 initialStartingPoint: UIViewController,
        ...
        container.initialStartingPoint = initialStartingPoint
        return container
    }
    ...
    override func viewDidLoad() {
        ...
        setupHorizontalScrollView(viewController: initialStartingPoint)
    }
    ...
    func setupHorizontalScrollView(viewController: UIViewController) {
        ...
        scrollView.contentOffset.x = viewController.view.frame.origin.x
